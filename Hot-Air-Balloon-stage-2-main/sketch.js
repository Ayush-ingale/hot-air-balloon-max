...
function safetykit() 
{
    ...
    //random y positions for top obstacles
    obstacletop.y = Math.round(random(500,height-50));

    //generate random top obstacles
    var rand = Math.round(random(1,3));
    switch(rand) {
      case 1: obstacletop.addImage(airfiller);
              break;
      case 2: obstacletop.addImage(repairkit);
              break;
              case 3: obstacletop.addImage(medkit);
              break;
      default: break;
    }
